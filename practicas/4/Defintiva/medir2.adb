...
procedure Medir2 is
	...
	Tm:Temperaturas:=0.0;		--temperatura media para la cuenta
	...
	Ct:Float;					--Coeficiente perdidas necesario para obtener el regimen permanante
	CpA:Float:=15.5;			--valor de Cp del apartado MEDIR1 para el calculo de Ct
	Aux1:Float;

begin -- Medir2

	Escribir(Pot);				--aplicamos potencia al horno
	delay L1;		--Esperamos un tiempo obtenido en MEDIR1 a que empiece a cambiar la temperatura
	...
	Put("Valor de Ct");
	New_Line;
	CP_Es.Put(Ct,Fore=>3,Aft=>3,Exp=>0);
	Put(" J/ºC");
	New_Line;
